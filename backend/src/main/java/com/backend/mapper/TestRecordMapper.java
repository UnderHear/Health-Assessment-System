...
public interface TestRecordMapper {
    ...
    @Insert("INSERT INTO test_record (user_id, name, age, gender, height, weight, bmi, body_fat_rate, " +
            ...
            "VALUES (#{userId}, #{name}, #{age}, #{gender}, #{height}, #{weight}, #{bmi}, #{bodyFatRate}, " +
    ...
    @Update("UPDATE test_record SET name = #{name}, age = #{age}, gender = #{gender}, height = #{height}, weight = #{weight}, " +
